...
globalNavDropdowns.prototype.checkCollision = function() {
    ...
    if (e.compact == 1) {
        ...
        n.left + n.width / 2 > t / 2 && (e.container.classList.remove("compact"),
        e.compact = !1)
    } else {
        var r = e.primaryNavItem.getBoundingClientRect()
          , i = e.secondaryNavItem.getBoundingClientRect();
        r.right > i.left && (e.container.classList.add("compact"),
        e.compact = !0)
    }
}
,
globalNavDropdowns.prototype.openDropdown = function(e) {
    ...
    window.siteAnalytics && window.siteAnalytics.trackGlobalNavDropdownOpen && window.siteAnalytics.trackGlobalNavDropdownOpen(n)
}
,
...
globalNavPopup.prototype.togglePopup = function() {
    ...
    e || this.root.classList.add(this.activeClass)
}
,
